...
export interface CacheMethods<R extends AnyObject, L extends AnyObject> {
  getSync: <K extends CacheKey<R, L>>(
    key: K,
  ) => CacheValue<R, L, K> | undefined;
  get: <K extends CacheKey<R, L>>(
    key: K,
  ) => Promise<CacheValue<R, L, K> | undefined>;
  setSync: <K extends CacheKey<R, L>>(
    key: K,
    value: CacheValue<R, L, K>,
  ) => void;
  set: <K extends CacheKey<R, L>>(
    key: K,
    value: CacheValue<R, L, K>,
  ) => Promise<void>;
